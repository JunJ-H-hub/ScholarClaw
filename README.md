...
## 🆕 ScholarClaw 是相对Paper-Agent的一次**升级重写**。它保留了旧版「检索 → 阅读 → 分析 → 写作」的多智能体核心思路，但在工程实现上做了全面升级：
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/a88a2823-9724-4a7a-aee4-fafbfef068a6" width="720" alt="ScholarClaw 会话工作台" />
  <br>
  <em>输入研究主题，实时追踪检索 → 阅读 → 分析 → 大纲 → 写作全流程进度</em>
</p>

<p align="center">
  <img src="https://github.com/user-attachments/assets/e312fc8b-d84e-46f5-86df-5202d2197dfe" width="720" alt="ScholarClaw 系统设置" />
  <br>
...
> **ScholarClaw 不只是论文摘要工具，而是一个完整的 AI 研究助理——它找得到论文、读得懂全文、理得清脉络、写得出综述。**
...
后端默认监听 `127.0.0.1:8010`，开发模式自动重载。API 文档：<http://127.0.0.1:8010/docs>
...
前端默认只监听本机，并代理 `/api`、`/webui` 请求到 `127.0.0.1:8010`。如需局域网其他设备访问：
...
## ❤️ 致谢
本项目基于开源项目Paper-Agent继续开发升级，感谢原项目作者及贡献者。
